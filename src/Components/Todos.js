...
const Todos = ({ task, deleteTodo, completeTodo }) => {
    ...
    return (
        <div className='w-80 h-11 border-none text-base rounded-md m-2 flex bg-black text-center items-center px-2 relative max-smallest:w-72'>
            <button className='m-0 p-0 flex justify-center hover:text-black hover:bg-white rounded-xl' title='Completed'><ion-icon name="radio-button-off-outline" onClick={handleComplete}></ion-icon></button>
